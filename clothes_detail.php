...
?>
   <img style="width:650px;height:450px; padding-left:200px; padding-top:20px" src="<?php echo "images/clothes/$prod_file"; ?>">
    ...
    <div class = "detail" style="padding-left:800px; margin-top:-300px">
      ...
      <a href="add_to_cart.php?cart_id=<?php echo $id; ?>"><button onclick="alert('Product added to cart Successfully!')" style="background-color:white; color:green; margin:10px; ">Add to Cart</button></a>
    </div>
