...
$sql = "SELECT * FROM electronic_device where id='$id' ";
...
?>
   <img style="width:650px;height:450px; padding-left:200px; padding-top:20px" src="<?php echo "images/electronic_device/$prod_file"; ?>">
