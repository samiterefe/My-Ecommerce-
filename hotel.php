...
echo "error:".$conn->connect_error;
       ...
       $sql = "SELECT company_name, product_name, product_file, description ,price, id FROM hotel";
     ...
     <div class="total">
       <ul>
          <?php  for($n=$amount;$n>=0;$n--): ?>
              <?php if($n==-1) break; ?>
              <div class = "detail">
              <li><strong><?php echo "$comp_name[$n]"; ?></strong></li>
              <li><img src="<?php echo "images/hotel/$prod_file[$n]"; ?>" width="300" height="350"></li>
              <li><strong>Price: </strong> <?php echo "$price[$n]"; ?> Birr</li>
              <li class="button"><a href="hotel_detail.php?detail_id=<?php echo $id[$n]; ?>"><button>Details</button></a></li>
              </div>
