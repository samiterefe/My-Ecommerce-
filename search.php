...
<html>
    ...
    <body>
        ...
        $sql = "SELECT * FROM electronic_device where product_name like '%$key%' ";
 ...
 <?php 
   $sql = "SELECT * FROM clothes  where product_name like '%$key%' ";
   $result = $conn->query($sql);
   if($result->num_rows>0){
 ?>    
...
<?php 
        $sql = "SELECT * FROM hotel  where product_name like '%$key%' ";
        $result = $conn->query($sql);
        if($result->num_rows>0){
?>
